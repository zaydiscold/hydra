...
test('account generator browser signup uses the encrypted proxy pool when present', () => {
  ...
  assert.match(source, /proxy: playwrightProxyForAutomation\(automationRoute\)/);
  assert.match(source, /viewport: \{ width: 1360, height: 900 \}/);
  assert.match(source, /screen: \{ width: 1360, height: 900 \}/);
  ...
  assert.match(source, /emailBlocked/);
  assert.match(source, /firstNameBlocked/);
  assert.match(source, /lastNameBlocked/);
  assert.match(source, /segmentedOtpVisible/);
  assert.match(source, /otpTextVisible/);
  assert.match(source, /text\.includes\('we sent a code'\)/);
  assert.match(source, /input\[aria-label\*="digit" i\]/);
