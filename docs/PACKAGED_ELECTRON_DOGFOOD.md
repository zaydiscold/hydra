...
Copy this table into `docs/RELEASE_AUDIT.md` when the packaged GUI run is
actually performed.
...
| Windows installer launch | Install and launch `release/Hydra-1.0.0-win-x64.exe` on Windows; record OS and result | pending |
